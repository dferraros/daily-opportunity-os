...
- [ ] Mapa completo de productos [external] con triggers por producto
...
- Análisis de datos históricos internos de [external] — se trabaja con benchmarks y estimaciones
- Integración con engineering/backend (BigQuery queries, API calls) — documentadas como dependencias, no implementadas

## Context

- **Plataforma**: [external] exchange multi-producto. Usuarios: 1.8M total, 600k excluidos, 23k MMU, 72.4k dormant con balance (€19.5M AUC)
