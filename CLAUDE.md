...
| **BigQuery Gold Layer** | V0a target Mar 10 — David Sales + Pablo T. 61h/5 weeks | `Bit2me 3/FASE3_Arquitectura_Tecnica.docx` |
| **A/B Testing Machine** | V1 done. V2 War Room UI designing (Mar 9). Target 15-20 tests/week | `Desktop/bit2me-ab-machine/` |
