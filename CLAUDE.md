# CLAUDE.md — Daniel Ferraro @ Bit2Me
...
**Daniel Ferraro** — Head of Growth, Bit2Me. Leads lifecycle marketing, campaign strategy, A/B testing, and growth operations.
...
| Project | Status | Path |
|---------|--------|------|
| **LC-OS Dashboard** | OPEN BUG: clusters.js Unicode parse abort | `Projects/bit2me-lifecycle-intel/` |
| **A/B Operator Console** | Next.js 14 War Room UI in progress, port 3001 | `Projects/bit2me-operator-console/` |
...
| **bit2me-growth-model** | Streamlit growth simulator. v1.0 done, retention model v2 open | `Projects/bit2me-growth-model/` |
| **Arranca** | Landing V3 done. Pending Daniel review | `Projects/Arranca/` |
| **A/B Machine** | V1 done. V2 pending Operator Console | `Projects/bit2me-ab-machine/` |
| **Playbook Triggers** | COMPLETE (Mar 22) | `Projects/PLAYBOOK_TRIGGERS_BIT2ME/` |
...
| **V0a-V10** | BigQuery Gold Layer views (11 total). schema: bit2me_lifecycle |
...
| What you need | Where to look |
|---|---|
| Bit2Me data context, SQL patterns, entity definitions | `memory/skills/bit2me-data-analyst/SKILL.md` |
